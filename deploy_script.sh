...
docker run --name clustering-entertainment-news -m 0.5g --cpus=0.5 -v /path/to/repo/clustering_entertaiment_news/logs:/clustering_entertainment_news/logs -p 5000:5000 clustering_entertainment_news
